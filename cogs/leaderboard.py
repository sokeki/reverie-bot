...
class Leaderboard(commands.Cog):
    ...
    @app_commands.command(name="leaderboard", description="See the Hall of Dreamers — top members by points")
    ...
    async def leaderboard(self, interaction: discord.Interaction, top: int = 10):
        ...
        ).sort("points", -1).limit(top).to_list(length=top)
        ...
        embed.set_footer(text=f"Top {top} dreamers  •  /points to check yourself  •  Reverie")
